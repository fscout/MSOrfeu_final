...
Revision ID: 0000e6a420cb
Revises: 
Create Date: 2021-06-15 23:41:32.455960
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('status_venda', sa.String(length=15), nullable=False),
    sa.Column('cod_status_venda', sa.Integer(), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('status_venda')
    )
    ...
    sa.Column('quantidade_produto', sa.Integer(), nullable=False),
    sa.Column('descricao_produto', sa.String(length=50), nullable=True),
